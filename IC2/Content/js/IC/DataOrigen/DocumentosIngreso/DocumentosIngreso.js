...
Ext.onReady(function () {
    ...
    var idServicio, servicio, idGrupo, grupo, idDeudor, deudor, minutos, claseDocumento;
    ...
    Ext.define('model_BuscarDocumentosIngreso',
        {
            ...
            fields: [
                ...
                { name: 'idDeudor', mapping: 'idDeudor' },
    ...
    var storeLlenaTrafico = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/LlenaTrafico?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
    ...
    var store_BuscarDocumentosIngreso = Ext.create('Ext.data.Store', {
        model: 'model_BuscarDocumentosIngreso',
        storeId: 'idstore_buscarDocumentosIngreso',
        pageSize: 20,
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/LlenaGrid?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
        ...
        listeners: {
            load: function () {
                var panels = Ext.ComponentQuery.query('#pnl_documentosIngreso');
                if (panels.length > 0) {
    ...
    var paginador = new Ext.PagingToolbar({
        id: 'paginador',
        store: store_BuscarDocumentosIngreso,
        displayInfo: true,
        ...
        items: [
            {
                ...
                listeners:
                {
                    change: function (field, newValue, oldValue, eOpts) {
                        ...
                        store_BuscarDocumentosIngreso.pageSize = cuenta;
                        store_BuscarDocumentosIngreso.load();
                    }
                }
            }
        ]
    ...
    var store_BorrarDocumentosIngreso = Ext.create('Ext.data.Store', {
        model: 'model_BuscarDocumentosIngreso',
        storeId: 'idstore_BorrarDocumentosIngreso',
        autoLoad: false,
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/BorrarDocumentosIngreso',
            reader: {
                type: 'json',
                root: 'results'
            },
            ...
            afterRequest: function (request, success) {
                var grp = Ext.getCmp('grp_DocumentosIngreso');
    ...
    var store_ModificarDocumentosIngreso = Ext.create('Ext.data.Store', {
        model: 'model_BuscarDocumentosIngreso',
        storeId: 'idstore_ModificarDocumentosIngreso',
        autoLoad: false,
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/ModificarDocumentosIngreso?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results'
            },
            ...
            afterRequest: function (request, success) {
                ...
                if (request.proxy.reader.jsonData.results == "ok") {
                    ...
                    var store = Ext.StoreManager.lookup('idstore_buscarDocumentosIngreso');
    ...
    var storeLlenaCompania = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/LlenaCompania?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var storeLlenaServicio = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/LlenaServicio?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var storeLlenaMoneda = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/LlenaMoneda?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var storeLlenaCodigoMaterial = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/LlenaCodigoMaterial?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var storeLlenaGrupo = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/LlenaGrupo?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var storeLlenaDeudor = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/LlenaDeudor?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var storeLlenaOperador = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/LlenaOperador?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var storeLlenaCuenta = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/LlenaCuenta?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var panel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            {
                html: "<div style='font-size:25px';>Documentos Ingresos</div><br/>",
                border: false,
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            ...
                            Ext.MessageBox.confirm('Confirmación', "¿Desea eliminar " + rec.length + " registro(s)? ",
                                function (btn, text) {
                                    if (btn == 'yes') {
                                        var store = Ext.StoreManager.lookup('idstore_BorrarDocumentosIngreso');
                        ...
                        items: [
                            ...
                            },
                            {
                                    ...
                                    listeners:
                                    {
                                        selectionchange: function (selected, eOpts) {
                                            if (eOpts.length == 1) {
                                                ...
                                                idDeudor = eOpts[0].data.idDeudor;
                                ...
                                columns: [
                                    ...
                                    {
                                        xtype: "gridcolumn", sortable: true, dataIndex: 'deudor', text: "Deudor", width: 100,
                                        renderer: function (v, cellValues, rec) {
                                    ...
                                    },
                                    {
                                        ...
                                        xtype: "numbercolumn", format: '0,000.0000', sortable: true, dataIndex: 'montoIva', text: "Monto IVA",
                                        ...
                                        xtype: "numbercolumn", format: '0,000.0000', sortable: true, dataIndex: 'montoFacturado', text: "Monto Facturado",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                                        ...
                                        xtype: "numbercolumn", format: '0,000.0000', sortable: true, dataIndex: 'tipoCambio', text: "Tipo Cambio",
                                        editor: {
                                            xtype: 'textfield'
                                        },
                                        items:
                    ...
                    items: [
                        {
                            ...
                            handler: function () {
                                ...
                                if (form.wasValid) {
                                    ...
                                    form.submit({
                                        url: '../' + VIRTUAL_DIRECTORY + 'DocumentosIngreso/AgregarDocumentosIngreso',
                                        waitMsg: "Nuevo",
                                        params:
                                        {
                                            ...
                                            idDeudor: Ext.getCmp('cmbDeudor').value,
                                            deudor: Ext.getCmp('cmbDeudor').getRawValue(),
        ...
        var frm_modificar = Ext.widget('form', {
                    ...
                    items: [
                        {
                            ...
                            html: "<button class='btn btn-primary' style='outline:none; font-size: 11px' accesskey='g'>Guardar</button>",
                            handler: function () {
                                var store = Ext.StoreManager.lookup('idstore_ModificarDocumentosIngreso');
                                ...
                                store.getProxy().extraParams.idDeudor = Ext.getCmp('cmbbDeudor').value;
                                store.getProxy().extraParams.deudor = Ext.getCmp('cmbbDeudor').getRawValue();
            ...
            items: [
                ...
                },
                {
                    ...
                    listeners: {
                        afterrender: function () {
                            this.setRawValue(deudor);
                            this.setValue(idDeudor);
                        }
                    }
                },
                {
    ...
    var lectura = ["grp_DocumentosIngreso", "btnResultados", "fechaDesdeC", "fechaHastaC"];
    var nuevo = ["btnGuardar"];
    var editar = ["btnEditar"];
    var eliminar = ["btnEliminar"];

    permisosVariosElementos('DocumentosIngreso', lectura, nuevo, editar, eliminar, 'log');
