...
Ext.onReady(function () {
    ...
    Ext.define('modelo',
        {
            ...
            fields: [
                { name: 'Id', mapping: 'Id' },
                { name: 'Operador_Id', mapping: 'Operador_Id' },
    ...
    var store_Buscar = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'Concepto/llenaGrid?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
        ...
        listeners: {
            load: function () {
                var panels = Ext.ComponentQuery.query('#panel_concepto');
                if (panels.length > 0) {
    ...
    var store_Borrar = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'Concepto/borrar',
            reader: {
                type: 'json',
                root: 'results'
            },
    ...
    var store_Modificar = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'Concepto/modificar',
            reader: {
                type: 'json',
                root: 'results'
            },
    ...
    var store_ValidaModifica = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'Concepto/validaModif',
            reader: {
                type: 'json',
                root: 'results'
            },
    ...
    var storeLlenaOperador = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'Concepto/llenaOperador?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var storeLlenaTrafico = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'Concepto/llenaTrafico?lineaNegocio=' + lineaNegocio,
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var panel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            {
                html: "<div style='font-size:25px';>Conceptos</div><br/>",
                border: false,
                margin: '0 0 0 10'
            },
            {
            ...
            },
            {
                ...
                columns: [
                    {
                        xtype: "gridcolumn", sortable: true, dataIndex: 'Nombre', flex: 1, locked: false, text: "Operador Id",
                    ...
                    {
                        xtype: "gridcolumn", sortable: true, dataIndex: 'Concepto1', flex: 1, locked: false, text: "Concepto",
                        renderer: function (v, cellValues, rec) {
                    ...
                    items: [
                        {
                            ...
                            handler: function () {
                                ...
                                if (form.wasValid) {
                                    form.submit({
                                        url: '../' + VIRTUAL_DIRECTORY + 'Concepto/agregar',
                                        waitMsg: "Nuevo",
                                        params:
                                        {
    ...
    permisosElementos('Concepto', 'grid', 'btnGuardar', 'btnEditar', 'btnEliminar', 'log');
