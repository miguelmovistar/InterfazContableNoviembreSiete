...
Ext.onReady(function () {
    ...
    var store_Buscar = Ext.create('Ext.data.Store', {
        ...
        listeners: {
            load: function () {
                var panels = Ext.ComponentQuery.query('#panel_cuenta_resultado');
                if (panels.length > 0) {
                                ...
                                if (form.wasValid) {
                                    form.submit({
                                        ...
                                        success: function (form, action) {
                                            ...
                                            store_Buscar.getProxy().extraParams.Trafico = Ext.getCmp('cmbTrafico').value;
    ...
    permisosElementos('CuentaResultado', 'grid', 'btnGuardar', 'btnEditar', 'btnEliminar', 'log');
