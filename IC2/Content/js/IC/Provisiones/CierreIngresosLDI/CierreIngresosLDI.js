...
Ext.onReady(function () {
    ...
    var storeLlenaPeriodo = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'CierreIngresosLDI/LlenaPeriodo?lineaNegocio=' + 2,
            reader: {
                type: 'json',
                root: 'results',
    ...
    var store_BuscarCierreIngresosLDI = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'CierreIngresosLDI/LlenaGrid',
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
    ...
    var panel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            {
                html: "<div style='font-size:25px';>Cierre Ingresos</div><br/>",
                border: false,
    ...
    permisosVariosElementos('CierreIngresosLDI', lectura, nuevo, editar, eliminar, 'log');
