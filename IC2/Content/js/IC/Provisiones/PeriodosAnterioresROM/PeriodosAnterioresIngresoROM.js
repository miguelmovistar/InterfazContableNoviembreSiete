...
Ext.onReady(function () {
    ...
    var modelo = [
        ...
        { name: 'Deudor', mapping: 'Deudor', width: '9%' },
        ...
        { name: 'Grupo', mapping: 'Grupo', width: '8%' },
        { name: 'Operador', mapping: 'IdOperador' },
        { name: 'Deudor', mapping: 'IdDeudor' },
    ...
    var storeLlenaPeriodo = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '..' + VIRTUAL_DIRECTORY + 'PeriodosAnterioresROM/LlenaPeriodoIngreso',
            reader: {
                type: 'json',
                root: 'results',
    ...
    var store_BuscarPeriodosAnterioresROM = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '..' + VIRTUAL_DIRECTORY + 'PeriodosAnterioresROM/LlenaGridIngreso',
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
            ...
            listeners: {
                exception: function (proxy, response, operation) {
                    Ext.Msg.alert('Excepción del Sistema', 'No se pudo completar la obtención de forma correcta', Ext.emptyFn);
                }
            }
        }
    });
    ...
    var panel = Ext.create('Ext.form.Panel', {
        ...
        flex: 1,
        items: [{
            html: '<div style="font-size:25px";> Ingresos de Periodos Anteriores ROM</div > <br />',
            border: false,
                ...
                items: [{ // Panel superior
                    ...
                    items: [{
                        ...
                        handler: function () {
                            Ext.Ajax.request({
                                timeout: 3600000,
                                url: '..' + VIRTUAL_DIRECTORY + 'PeriodosAnterioresROM/ExportarReporteIngreso',
                                method: 'POST',
                                params: {
