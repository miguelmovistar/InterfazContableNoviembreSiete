/* Nombre: FluctuacionIngresosROM.js
*Creado por: Ana Ilse Aguila Rojas
*Fecha: 04/sept/2019
*Descripcion: Front de Fluctuacion Cambiaria Ingresos ROM
...
Ext.onReady(function () {
    ...
    var store_BuscarFluctuacionCambiariaROM = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'FluctuacionIngresosROM/LlenarGridFluctuacion',
            reader: {
                type: 'json',
                root: 'results',
    ...
    var storeLlenaPeriodo = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'FluctuacionIngresosROM/LlenaPeriodo',
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success'
    ...
    var panel = Ext.create('Ext.form.Panel', {
        ...
        items: [
            {
                html: "<div style='font-size:25px';>Fluctuación Cambiaria Ingresos</div><br/>",
                bodyStyle: { "background-color": "#E6E6E6" },
                border: false,
                width: '50%',
            },
                        ...
                        items: [
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function () {
                                            ...
                                            Ext.Ajax.request({
                                                timeout: 3600000,
                                                url: '../' + VIRTUAL_DIRECTORY + 'FluctuacionIngresosROM/ExportarReporte',
                                                params: {
                                                    Periodo: periodo
                                                },
                            ...
                            },
                            {
                                ...
                                columns: [
                                    ...
                                    //nombreDeudor
                                    {
                                        xtype: 'gridcolumn', text: "Deudor", dataIndex: 'deudor', sortable: true, locked: false, align: 'center', resizable: true,
                                        renderer: function (v, cellValues, rec) {
                                    ...
                                    //Tipo
                                    {
                                        xtype: 'gridcolumn', text: "Tipo", dataIndex: 'tipo', sortable: true, locked: false, align: 'center', resizable: true, width: 100,
                                        renderer: function (v, cellValues, rec) {
                                            return rec.get('tipo');
                                        },
                                        editor: {
                                    ...
                                    //importe_Provision
                                    {
                                        xtype: 'gridcolumn', text: "Importe Provisión MD", dataIndex: 'importe_Provision', sortable: true, locked: false, align: 'right', resizable: true, width: 100,
                                        renderer: function (v, cellValues, rec) {
    ...
    var lectura = ["grdTotalesFluctuacionCambiariaROM", "grdFluctuacionCambiariaROM", "btnBuscar", "btnExportar"];
    var nuevo = null;
    var editar = null;
    var eliminar = null;

    permisosVariosElementos('FluctuacionIngresosROM', lectura, nuevo, editar, eliminar, 'log');
