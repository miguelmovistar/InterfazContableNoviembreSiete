/* Nombre: FluctuacionIngresosLDI.js
*Creado por: Ana Ilse Aguila Rojas
*Fecha: 06/jun/2019
*Descripcion: Front de Fluctuacion Cambiaria Ingresos LDI
...
Ext.onReady(function () {
    ...
    var store_BuscarFluctuacionCambiariaLDI = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'FluctuacionIngresosLDI/LlenarGridFluctuacion',
            reader: {
                type: 'json',
                root: 'results',
    ...
    var storeLlenaPeriodo = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: '../' + VIRTUAL_DIRECTORY + 'FluctuacionIngresosLDI/LlenaPeriodo',
            reader: {
                type: 'json',
                root: 'results',
                successProperty: 'success',
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function () {
                                            ...
                                            Ext.Ajax.request({
                                                timeout: 3600000,
                                                url: '../' + VIRTUAL_DIRECTORY + 'FluctuacionIngresosLDI/ExportarReporte',
                                                params: {
                                                    Periodo: periodo
                                                },
    ...
    var lectura = ["btnBuscar", "btnExportar", "grdTotalesFluctuacionCambiariaLDI", "grdFluctuacionCambiariaLDI"];
    var nuevo = null;
    var editar = null;
    var eliminar = null;

    permisosVariosElementos('FluctuacionIngresosLDI', lectura, nuevo, editar, eliminar, 'log');
