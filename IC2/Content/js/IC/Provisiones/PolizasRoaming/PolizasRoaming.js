...
*Fecha:  26/08/2019
*Descripcion: PolizasRoaming S1/S3/SA
*/
...
Ext.onReady(function () {
	...
	var store_Buscar = Ext.create('Ext.data.Store', {
		...
		proxy: {
			type: 'ajax',
			url: '../' + VIRTUAL_DIRECTORY + 'PolizasRoaming/LlenarGridPolizas?lineaNegocio=' + lineaNegocio,
			reader: {
				type: 'json',
				root: 'results',
	...
	var store_BuscarCabeceraArchivo = Ext.create('Ext.data.Store', {
		...
		proxy: {
			type: 'ajax',
			url: '../' + VIRTUAL_DIRECTORY + 'PolizasRoaming/ObtenerCabeceraArchivo',
			reader: {
				type: 'json',
				root: 'results',
			},
	...
	var store_BuscarCabeceraRegistro = Ext.create('Ext.data.Store', {
		...
		proxy: {
			type: 'ajax',
			url: '../' + VIRTUAL_DIRECTORY + 'PolizasRoaming/ObtenerCabeceraRegistro',
			reader: {
				type: 'json',
				root: 'results',
			},
	...
	var storePeriodo = Ext.create('Ext.data.Store', {
		...
		proxy: {
			type: 'ajax',
			url: '../' + VIRTUAL_DIRECTORY + 'PolizasRoaming/llenaPeriodo',
			reader: {
				type: 'json',
				root: 'results',
				successProperty: 'success',
	...
	var store_BuscarDetalleRegistro = Ext.create('Ext.data.Store', {
		...
		proxy: {
			type: 'ajax',
			url: '../' + VIRTUAL_DIRECTORY + 'PolizasRoaming/ObtenerDetalleRegistro',
			reader: {
				type: 'json',
				root: 'results',
			},
	...
	var store_ObtenerEditarMultiple = Ext.create('Ext.data.Store', {
		...
		proxy: {
			type: 'ajax',
			url: '../' + VIRTUAL_DIRECTORY + 'PolizasRoaming/ObtenerEditarMultiple',
			//params:
			//{
			//    arrayParam: miArray,
	...
	var strore_ModificarMultiple = Ext.create('Ext.data.Store', {
		...
		proxy: {
			type: 'ajax',
			url: '../' + VIRTUAL_DIRECTORY + 'PolizasRoaming/EditarMultipleIdLinea',
			reader: {
				type: 'json',
				root: 'results'
			},
		...
		items: [
				...
				items: [
					...
					},
					{
						...
						handler: function () {
							...
							form.submit({
								url: '../' + VIRTUAL_DIRECTORY + 'PolizasRoaming/CancelarPoliza',
								waitMsg: "Cargando...",
					...
					},
					{
						...
						handler: function () {
							var form = this.up('form').getForm();
							form.submit({
								url: '../' + VIRTUAL_DIRECTORY + 'PolizasRoaming/EnviarPolizas',
								waitMsg: "Cargando...",
					...
					},
					{
						...
						handler: function () {
							var form = this.up('form').getForm();
							form.submit({
								url: '../' + VIRTUAL_DIRECTORY + 'PolizasRoaming/RespuestaSAP',
								waitMsg: "Cargando...",
			...
			//Primer tabla
			{
				...
				columns: [
					...
					{
						xtype: "gridcolumn", sortable: true, dataIndex: 'Poliza', width: 100, locked: false, text: "Id",
						...
						items: [
							{
								...
								columns:
									[
										...
										{
											xtype: "gridcolumn", width: 100, sortable: true, dataIndex: 'SociedadSiSonCuentasDeIngresos', locked: false, text: "Sociedad Si SonCuentas De Ingresos",
											renderer: function (v, cellValues, rec) {
												return rec.get('SociedadSiSonCuentasDeIngresos');
											},
											editor: {
												xtype: 'textfield'
											},
										...
										{
											xtype: "gridcolumn", width: 100, sortable: true, dataIndex: 'Ambito', locked: false, text: "Abito",
											renderer: function (v, cellValues, rec) {
