...
namespace IC2.Models
{
    ...
    public partial class PXQIngresosROM
    {
        ...
        public Nullable<decimal> PROV_NC_M2M_USD { get; set; }
        public Nullable<decimal> PROVRealTarifaMesAnteriorUSD { get; set; }
        public Nullable<decimal> ajustePROV_M2M_USD_MesAnterior { get; set; }
        public Nullable<decimal> PROV_TAR_MesAnteriorUSD { get; set; }
        public Nullable<decimal> ajusteRal_VS_DevengoTarifaMesAnterior { get; set; }
        public Nullable<decimal> total_USD_PROV_Tarifa { get; set; }
        public Nullable<decimal> facturacion_REALTraficoMesAnterior { get; set; }
        ...
        public Nullable<decimal> totalNetoUSD { get; set; }
